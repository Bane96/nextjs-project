        ...
        <>
            {Array.from({length: elementsCount}).map((_, index) => (
                ...
                <div key={index} role="status"
                     className="max-w-sm border border-gray-200 shadow-sm animate-pulse dark:border-gray-200 rounded-xl">
                    <div
                        className="flex items-center justify-center h-[200px] mb-4 bg-gray-200 rounded-t-lg dark:bg-gray-200">
                        <svg className="w-10 text-gray-200 dark:text-gray-300" aria-hidden="true"
